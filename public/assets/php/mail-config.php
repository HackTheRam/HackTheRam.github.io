...
$admin_email_to        = 'website@hacktheram.com'; /* Admin Email; Who Will Get The Contact Email Alert */

$admin_email_name   = "Hack the Ram Admin"; /* Admin Name/Company name who will get the email alert */

$admin_email_from       = 'website@hacktheram.com'; /* Admin email from which email address email will be sent */

$admin_email_from_name  = 'Hack the Ram Info'; /* Admin name from which email will be sent */


$use_custom_subject = false; /* If you want to use custom subject then set true. To use form subject just ignore it. */

$admin_email_subject = 'A new message from Hack the Ram'; /* Custom email subject what the admin will get as contact email alert*/
